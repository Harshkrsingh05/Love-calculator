...
document.querySelector(".button").addEventListener("click",()=>{
  ...
  if(yourName.value==="krish tiwari" || yourName.value==="roshan r" || yourName.value==="anurag chandra" || yourName.value==="aman maurya" ||yourName.value==="kunal"){
    document.body.innerHTML = document.body.innerHTML.replace('Try your Luck above.', "Your love success percentage is: 100%");
  }
  else if(yourName.value==="Shivam" || yourName.value==="Aditya" || yourName.value==="Aman" ){
